# routes/leads/leads.py - COMPLETE FIXED VERSION
...
def prepare_lead_data_for_db(lead_data: dict) -> dict:
    """Prepare lead data for database insertion - FIXED VERSION"""
...
def create_lead(
    ...
    """Create a new lead with FIXED JSON handling"""
    try:
        ...
        # Prepare data for database - FIXED PROCESSING
...
async def create_lead_with_files(
    ...
    segment: Optional[str] = Form(None),  # Will be converted to list
