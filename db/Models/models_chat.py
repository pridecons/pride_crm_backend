# db/Models/models_chat.py
from sqlalchemy import (
    Column, Integer, String, Text, DateTime, Boolean, ForeignKey, Enum, Index,
...
from db.models import UserDetails  # assuming you already have this (crm_user_details table)
...
class ChatAttachment(Base):
    ...
    url = Column(String(1024), nullable=False)       # served path (e.g. /static/uploads/chat/..)
    thumb_url = Column(String(1024), nullable=True)  # optional thumbnail for images
    ...
    __table_args__ = (
        ...
        Index("ix_chat_attachments_mime", "mime_type"),
    )
