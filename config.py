...
AIRTEL_IQ_SMS_URL = os.getenv("AIRTEL_IQ_SMS_URL")
BASIC_AUTH_USER = os.getenv("BASIC_AUTH_USER")
BASIC_AUTH_PASS = os.getenv("BASIC_AUTH_PASS")
BASIC_IQ_CUSTOMER_ID = os.getenv("BASIC_IQ_CUSTOMER_ID")
BASIC_IQ_ENTITY_ID = os.getenv("BASIC_IQ_ENTITY_ID")

PAYMENT_LIMIT = 178000

VBC_ACCOUNT_ID = os.getenv("VBC_ACCOUNT_ID")
